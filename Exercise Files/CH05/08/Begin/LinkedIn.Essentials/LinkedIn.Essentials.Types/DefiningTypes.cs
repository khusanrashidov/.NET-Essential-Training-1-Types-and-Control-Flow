...
// The other way to handle null reference exceptions is to make sure that constructors
// for types, initialize anything that is a non nullable reference type or value type.

...
public struct BiologicalNotChronological //: IPerson, Age
{
    // Value types (meaning struct and record struct) cannot have a base class but can implement interfaces.
    // struct cannot inherit from base struct whereas class can derive from base class
}

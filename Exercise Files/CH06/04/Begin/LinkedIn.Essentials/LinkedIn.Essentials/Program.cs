...
// Patterns are used with the is statement, the switch expression, or the switch statement.

string? input = "KaneKate";
int definiteInt;
int? age = null;
...
IPerson mgr = new Manager { FirstName = "Manager", LastName = "Worker", NumberOfDirectReports = 8 };
...
{
    var result = p switch // C# 7 pattern
    {
    ...
    //}
    return String.Empty; // Unreachable code.
}